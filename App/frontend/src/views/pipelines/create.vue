<template>
  <div class="py-6 grid grid-cols-12 px-8 gap-4">
    <div
      class="md:col-span-12 lg:col-span-8 flex flex-col space-y-5 items-center"
    >
      ...
      <div class="w-full flex flex-col space-y-6">
        <div class="w-full flex flex-col space-y-3">
          ...
          <div
            class="w-full flex flex-row whitespace-nowrap space-x-5 items-center"
          >
            <div
            ...
            >
              ...
              <bp-normal-text :customClass="'font-semibold'">
                Bitbucket
              </bp-normal-text>
            </div>

            <div
              class="w-[110px] h-[110px] bg-[whitesmoke] shadow-md rounded-md py-4 px-4 flex flex-col space-y-3 items-center justify-center"
            >
        ...
        <div class="w-full flex flex-row items-center justify-start">
          <bp-button padding="py-3 px-5" @click="createServicePipeline()">
            Add pipeline
          </bp-button>
        </div>
...
export default defineComponent({
  ...
  setup() {
    ...
    watch(workspaceId, () => [
      Logic.Pipeline.GetRepositories(workspaceId.value),
    ]);

    const createServicePipeline = () => {
      const selectedRepository = Repositories.value?.filter(
        (repo) => repo.slug == repoId.value
      );
